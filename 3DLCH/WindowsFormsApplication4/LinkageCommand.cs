...
namespace WindowsFormsApplication4
{
    ...
    /// </summary>
    [Guid("1a19f0a8-bc60-4093-a779-8bb9f3e96e4f")]
    [ClassInterface(ClassInterfaceType.None)]
    [ProgId("WindowsFormsApplication4.Command2")]
    public sealed class LinkageCommand : BaseCommand
    {
        ...
        public LinkageCommand()
        {
            //
            // TODO: Define values for the public properties
            //
            base.m_category = "三维二维联动"; //localizable text
            base.m_caption = "三维二维联动";  //localizable text
            ...
            base.m_toolTip = "三维二维联动";  //localizable text 
            base.m_name = "联动";   //unique id, non-localizable (e.g. "MyCategory_MyCommand")
